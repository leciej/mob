...
namespace SolutionOrdersReact.Server.Migrations
{
    ...
    [Migration("20260107221817_AddUserIdToOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SolutionOrdersReact.Server.Models.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SolutionOrdersReact.Server.Models.CartOrderSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CartOrderSnapshots");
                });

            modelBuilder.Entity("SolutionOrdersReact.Server.Models.CartOrderSnapshotItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CartOrderSnapshotId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CartOrderSnapshotId");

                    b.ToTable("CartOrderSnapshotItems");
                });
            ...
            modelBuilder.Entity("SolutionOrdersReact.Server.Models.CartOrderSnapshotItem", b =>
                {
                    b.HasOne("SolutionOrdersReact.Server.Models.CartOrderSnapshot", "CartOrderSnapshot")
                        .WithMany("Items")
                        .HasForeignKey("CartOrderSnapshotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CartOrderSnapshot");
                });
